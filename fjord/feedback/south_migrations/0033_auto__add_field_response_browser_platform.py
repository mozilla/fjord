...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Response.browser_platform'
        db.add_column(u'feedback_response', 'browser_platform',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Response.browser_platform'
        db.delete_column(u'feedback_response', 'browser_platform')
