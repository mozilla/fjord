...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.translation_system'
        db.add_column(u'feedback_product', 'translation_system',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.translation_system'
        db.delete_column(u'feedback_product', 'translation_system')
