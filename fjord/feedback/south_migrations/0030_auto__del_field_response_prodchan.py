...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Response.prodchan'
        db.delete_column(u'feedback_response', 'prodchan')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Response.prodchan'
        raise RuntimeError("Cannot reverse this migration. 'Response.prodchan' and its values cannot be restored.")
