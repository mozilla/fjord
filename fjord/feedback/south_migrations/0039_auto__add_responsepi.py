...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ResponsePI'
        db.create_table(u'feedback_responsepi', (
        ...
        db.send_create_signal(u'feedback', ['ResponsePI'])


    def backwards(self, orm):
        # Deleting model 'ResponsePI'
        db.delete_table(u'feedback_responsepi')
