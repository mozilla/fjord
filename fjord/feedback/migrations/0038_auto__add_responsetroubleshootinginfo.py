...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ResponseTroubleshootingInfo'
        db.create_table(u'feedback_responsetroubleshootinginfo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('opinion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feedback.Response'])),
            ('data', self.gf('fjord.base.models.JSONObjectField')(default={})),
        ))
        db.send_create_signal(u'feedback', ['ResponseTroubleshootingInfo'])


    def backwards(self, orm):
        # Deleting model 'ResponseTroubleshootingInfo'
        db.delete_table(u'feedback_responsetroubleshootinginfo')
