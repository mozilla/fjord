...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'feedback_product', (
            ...
            ('db_name', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('on_dashboard', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'feedback', ['Product'])


    def backwards(self, orm):
        # Deleting model 'Product'
        db.delete_table(u'feedback_product')
