...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.image_file'
        db.add_column(u'feedback_product', 'image_file',
                      self.gf('django.db.models.fields.CharField')(default=u'noimage.png', max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.image_file'
        db.delete_column(u'feedback_product', 'image_file')
